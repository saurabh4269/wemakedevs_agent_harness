...
Something that used to work now fails. LOOP's job:
...
2. Patch **in the sandbox**, not in production.
...
Then, if a human wants a GitHub draft, follow license-to-write. Never merge. Never prod-deploy the tenant.
...
3. A draft PR is optional and still gated. Prefer a written proposal in chat.
